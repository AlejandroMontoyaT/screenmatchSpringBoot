...
public class ScreenmatchApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		//SE CREA NUEVA INSTANCIA DESPUESDE QUE SE ELIMINA LA PARTE DE ABAJO QUE ES MUY REPETITIVO VOLVER A PEDIR EL VALOR
		Principal principal = new Principal();
		principal.muestraElMenu();


		/**
		 ESTA PARTE SE ELIMINA POR QUE  SERIA REPETITIVO VOLVER A CONSULTAR EL MISMO DATO VARIAS VECES
	...
	//	var json = consumoAPI.obtenerDatos("https://coffee.alexflipnote.dev/random.json");
		...
		//crear lista para refacotrizar esto se pasa a la clase principal
